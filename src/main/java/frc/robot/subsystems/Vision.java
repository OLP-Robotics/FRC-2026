...
public class Vision extends SubsystemBase {
    ...
    public void activate() {
        if (idAprilTag != 0) {
            // Relative to when looking at camera feed
            // left: -x, right: x
            // up: -y, down: y
            // forward and back: z

            // System.out.format("%s position(x,y,z): %.3f, %.3f, %.3f\n", idAprilTag,
            // (posAndRot[0]*3.28), (posAndRot[1]*3.28), (posAndRot[2]*3.28));

            // gives values in centimeters
            // ex: 3 position(x,y,z): -0.058, 0.010, 0.578
